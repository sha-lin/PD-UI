...
const menuSections: MenuSection[] = [
    {
        title: "MAIN",
        items: [
            { label: "Dashboard", href: "/vendors/dashboard", icon: LayoutDashboard },
        ],
    },
    {
        title: "OPERATIONS",
        items: [
            { label: "Purchase Orders", href: "/vendors/purchase-orders", icon: FileText },
            { label: "Proofs & Samples", href: "/vendors/proofs", icon: Camera },
            { label: "Invoicing", href: "/vendors/invoices", icon: DollarSign },
            { label: "Issues & Requests", href: "/vendors/issues", icon: AlertTriangle },
        ],
    },
    {
        title: "ANALYTICS",
