...
export const LoaderOne = ({ variant = "default" }: { variant?: "default" | "light" }) => {
  ...
  const colors = variant === "light"
    ? { primary: "bg-white", secondary: "bg-brand-yellow" }
    : { primary: "bg-brand-yellow", secondary: "bg-brand-blue" };
  ...
  return (
    <div className="flex items-center gap-2">
      <motion.div
        ...
        className={`h-4 w-4 rounded-full ${colors.primary}`}
      />
      <motion.div
        initial={{
          y: 0,
        ...
        className={`h-4 w-4 rounded-full ${colors.secondary}`}
      />
      <motion.div
        initial={{
          y: 0,
