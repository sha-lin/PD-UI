...
export default function AccountManagerNotificationsPage(): ReactElement {
    ...
    const notificationsQuery = useQuery({
        queryKey: ["account-manager-notifications", query],
    ...
    const markReadMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            queryClient.invalidateQueries({ queryKey: ["account-manager-notifications"] });
        },
        onError: () => {
        ...
        <AccountManagerLayout>
            <header className="border-b border-gray-200 bg-white">
                <div className="px-8 py-4">
                    <h1 className="text-2xl font-bold text-gray-900">Account Manager Notifications</h1>
                    <p className="mt-2 text-sm text-gray-600">
                        Notifications scoped to account manager activities.
                    </p>
                </div>
            </header>
                        ...
                        <div className="divide-y divide-gray-100">
                            {notifications.length === 0 ? (
                                <div className="p-8 text-center">
                                    ...
                                    <p className="mt-3 text-sm text-gray-500">No notifications available.</p>
                                </div>
                            ) : (
