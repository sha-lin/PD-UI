import { PaymentsSummary } from "@/types/payments";

interface PaymentsSummaryStripProps {
    summary: PaymentsSummary;
}

export default function PaymentsSummaryStrip({ summary }: PaymentsSummaryStripProps) {
    ...
    const items = [
        ...
        },
        {
            ...
            value: (summary.failed_count + summary.refunded_count).toLocaleString(),
            helper: `${summary.failed_count} failed, ${summary.refunded_count} refunded`,
        },
    ];
