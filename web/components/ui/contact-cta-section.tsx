export default function ContactCTASection() {
    return (
        <div className="max-w-5xl w-full mx-auto p-10 text-gray-800 py-16 md:py-20">
            ...
            <div className="grid md:grid-cols-3 mt-16 gap-8">
                <div>
                    <svg className="text-brand-blue bg-brand-blue/20 p-2.5 aspect-square rounded-full size-10" width="24"
                    ...
                    <a href="mailto:query@printduka.co.ke" className="text-brand-blue font-semibold hover:underline">
                        query@printduka.co.ke
                    </a>
                </div>
                <div>
                    ...
                    <span className="text-brand-blue font-semibold">
                        Parsonic Business Centre, Kweria/Kirinyaga Rd
                    </span>
                </div>
                <div>
                    <svg className="text-brand-blue bg-brand-blue/20 p-2.5 aspect-square rounded-full size-10" width="21"
                    ...
                    <a href="tel:0795332766" className="text-brand-blue font-semibold hover:underline">
                        0795 332766
                    </a>
                </div>
            </div>
